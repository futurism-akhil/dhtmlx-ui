        ...
        function baseIsEqual(value, other, callback, isWhere, stackA, stackB) {
            ...
            if (!isArr) {
                ...
                if (!hasValCtor) {
                    ...
                    if (valCtor != othCtor && !(isFunction(valCtor) && valCtor instanceof valCtor && isFunction(othCtor) && othCtor instanceof othCtor) &&
     ...
     * }
        ...
        function keysIn(object) {
            ...
            for (var key in object) {
                if (!(isProto && key == 'constructor') && !(skipIndexes && (keyIndex = +key, keyIndex > -1 && keyIndex <= maxIndex && keyIndex % 1 == 0))) {
                    result.push(key);
                }
            }
            return result;
